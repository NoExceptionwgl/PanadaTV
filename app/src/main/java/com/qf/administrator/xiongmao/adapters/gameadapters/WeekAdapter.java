...
public class WeekAdapter extends RecyclerView.Adapter<WeekAdapter.ViewHolder> {
    ...
    public WeekAdapter(List<WeekModel> data, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View layout = inflater.inflate(R.layout.week_fragment, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @InjectView(R.id.stu_toplist_week_item_left_iv)
        ImageView mLeftIv;
        @InjectView(R.id.stu_toplist_week_item_touxiang_iv)
        ImageView mTouxiangIv;
        @InjectView(R.id.stu_toplist_week_item_duanwei_iv)
        ImageView mDuanweiIv;
        @InjectView(R.id.stu_toplist_week_item_name_tv)
        TextView mNameTv;
